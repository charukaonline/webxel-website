...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/HomeWeb.css">
...
<div class="main">
    ...
    <div class="container-three">
        <div class="firstlook">
            <div class="firstlook-left">
                <div class="firstlook-text"><h1><span class="firstlook-header">Create your</span><br>Dream Website</h1></div>
    ...
    <div class="container-four">
        <div class="maincnt">
            <div class="one-count"><div class="one-counter" data-val="121">0</div>  <i class="material-icons" id="icon">dvr</i></span> <br> <span class="">Projects</span>  </div>
            <div class="two-count"><div class="two-counter" data-val="23">0</div>   <i class="fa fa-group" id="icon"></i></span>   <br>  <span class="">Our Team</span>  </div>
            <div class="three-count"><div class="three-counter" data-val="18">0</div>  <i class="material-icons" id="icon">extension</i></span> <br> <span class="">Awards</span>  </div>
        </div>
    </div>
